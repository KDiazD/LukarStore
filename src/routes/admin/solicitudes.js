...
router.get('/', async (req, res) => {
    ...
    res.render('links/admin/solicitudes_productos', {
        layout: "main_admin",
        productos: productos,
...
router.post('/update/:id_productos', async (req, res) => {
    ...
    const updateEstado = req.body;
    await pool.query('UPDATE productos set ? WHERE id_productos = ?', [updateEstado, id_productos]);
